...
# 读取数据
dataset_train = datasets.ImageFolder(r'E:\2D_Data\Small_data\train', transform_train)
dataset_test = datasets.ImageFolder(r'E:\2D_Data\Small_data\test', transform_test)
# 获取数据集长度
...
epoch = 60
# 添加tensorboard
log_dir = r"log\logs_fit_" + datetime.datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
